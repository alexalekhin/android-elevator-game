...
public class Level2 implements Level {
    ...
    public Level2(Game game, GameView gameView, int maxPersons, Float maxAnger, int floorsNumber) {
        this.game = game;
        ...
        if (gameView != null) {
            ...
            //4 basic floors
            Floor f0 = new Floor(gameView, 0, 0, 4,
                    gameView.getBmps().bmpFloor1,
                    floorsNumber - floors.size());
            floors.add(f0);

            Floor f1 = new Floor(gameView, f0.rect.left, f0.rect.bottom, 4,
                    gameView.getBmps().bmpFloor2,
                    floorsNumber - floors.size());
            floors.add(f1);
            Floor f2 = new Floor(gameView, f1.rect.left, f1.rect.bottom, 4,
                    gameView.getBmps().bmpFloor3,
                    floorsNumber - floors.size());
            floors.add(f2);
            Floor f3 = new Floor(gameView, f2.rect.left, f2.rect.bottom, 4,
                    gameView.getBmps().bmpFloor1,
                    floorsNumber - floors.size());
            floors.add(f3);
            ...
            elevator = new Elevator(gameView,
                    (int) (elevatorPositions.get(2).left), (int) (elevatorPositions.get(2).top), 4,
            ...
            Person p0_1 = new Person(gameView, p0_0.getRect().right, p0_0.getRect().top,
                    ...
                    elevator, floors.get(0), floors.get(3));
            persons.add(p0_1);
            f0.persons.add(p0_1);
            //f1
            ...
            Person p3_0 = new Person(gameView, 0.0f, 0.0f,
                    gameView.getBmps().bmpFemRight, gameView.getBmps().bmpFemLeft,
                    elevator, floors.get(3), floors.get(0));
            persons.add(p3_0);
            f3.persons.add(p3_0);
            Person p3_1 = new Person(gameView, p3_0.getRect().right, p3_0.getRect().top,
                    gameView.getBmps().bmpMRight, gameView.getBmps().bmpMLeft,
                    elevator, floors.get(3), floors.get(1));
            persons.add(p3_1);
            f3.persons.add(p3_1);
/*
...
*/
        ...
        //elevator = new Elevator(gameView, floors.get(2).rect.right, floor\s.get(2).rect.top, gameView.getResources(), R.drawable.elevator);
